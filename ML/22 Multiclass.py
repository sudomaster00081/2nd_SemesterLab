# Download any multiclass numerical dataset from UCI repostiory and do the classification with  
...
voting_model = VotingClassifier(estimators=[('svm1', svm_model_1), ('svm2', svm_model_2), ('svm3', svm_model_3)], voting='hard')
